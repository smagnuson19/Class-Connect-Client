    ...
    return (
      <div className="sign-in-up-content-container">
        ...
        <form>
          ...
          <Button type="submit" variant="raised" color="primary" className="submit" onClick={(e) => { e.preventDefault(); this.props.signinUser(this.state, this.props.history); }}>Sign In</Button>
        </form>
      </div>
    );
  }
